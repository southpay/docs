...
| Research token prices (public market data) | None - public data, no credential needed |
...
- **[Authorization](/agentic/authorization)** - three independent safety layers: credential scopes, per-asset spend limits with daily counters, and cryptographic mandates verified through an authorization provider.
